...
public class NacosUserDetailsServiceImpl implements UserDetailsService {
    ...
    private void reload() {
        try {
            Page<com.alibaba.nacos.plugin.auth.impl.persistence.User> users = getUsersFromDatabase(1, Integer.MAX_VALUE, StringUtils.EMPTY);
            if (users == null) {
                return;
            }

            Map<String, com.alibaba.nacos.plugin.auth.impl.persistence.User> map = new ConcurrentHashMap<>(16);
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        com.alibaba.nacos.plugin.auth.impl.persistence.User user = userMap.get(username);
    ...
    public Page<com.alibaba.nacos.plugin.auth.impl.persistence.User> getUsersFromDatabase(int pageNo, int pageSize, String username) {
        return userPersistService.getUsers(pageNo, pageSize, username);
    }

    public com.alibaba.nacos.plugin.auth.impl.persistence.User getUser(String username) {
        com.alibaba.nacos.plugin.auth.impl.persistence.User user = userMap.get(username);
    ...
    public com.alibaba.nacos.plugin.auth.impl.persistence.User getUserFromDatabase(String username) {
