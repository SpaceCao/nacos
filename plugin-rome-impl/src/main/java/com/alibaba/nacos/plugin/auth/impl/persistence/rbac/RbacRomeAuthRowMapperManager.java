...
/**
  ...
  **/
public class RbacRomeAuthRowMapperManager {
    ...
    public static final class RomePermissionRowMapper implements RowMapper<RbacRomePermissionInfo> {

        @Override
        public RbacRomePermissionInfo mapRow(ResultSet rs, int rowNum) throws SQLException {
            RbacRomePermissionInfo info = new RbacRomePermissionInfo();
